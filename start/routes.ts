...
const UpdateUserNamesController = async () =>
  await import('#controllers/update_user_names_controller')
const UpdateUserEmailsController = async () =>
  await import('#controllers/update_user_emails_controller')
const UpdateUserPasswordsController = async () =>
  await import('#controllers/update_user_passwords_controller')
const UpdateUserAvatarsController = async () =>
  await import('#controllers/update_user_avatars_controller')
  ...
  .group(() => {
    ...
    router
      .group(() => {
        ...
        router.post('/users/:id/update-avatar', [UpdateUserAvatarsController])
